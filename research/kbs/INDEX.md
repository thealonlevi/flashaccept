...
- [teardown-redraw2](teardown-redraw2.md) — teardown drew 42814/43265/42092 (mean ~champion); SAME binary's perf_instr_pc swings 22889-24668 (~8%) — BOTH metrics too noisy for the 3% gate. Architecture at contract floor; re-drawing the lowest-CQE config (teardown) remains highest-EV but the blocker is harness noise (PROPOSALS).
